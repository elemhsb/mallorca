...
#ifndef SPI_ARCH_NEW_H
#define SPI_ARCH_NEW_H
...
#define Spi2Slave0Unselect() { CSSEL(CS_UNSEL); /* LED_OFF(8); LED_OFF(7); LED_OFF(9); */}
#define Spi2Slave0Select() { CSSEL(CS_ACC); /* LED_ON(8); LED_ON(7); LED_ON(9); */}
